...
public class OneTimePasswordAlgorithm {
	...
	public void resynchHOTPUserTokenTest() throws Exception {
		...
		String secret = "431821a5b42b2d3d3820855770317607fc3dcb70";

		byte[] secretAsBytesArray = new BigInteger(secret, 16).toByteArray();

		String key = null;
		for (int movingFactor = 0; movingFactor < 200; ++movingFactor) {

			key = otp
					.generateOTP(secretAsBytesArray, movingFactor, 6, false, 16);
			System.out.println("movingFactor : " + movingFactor + " key : " +key);
		}
	}
